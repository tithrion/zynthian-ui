...
uint32_t Track::getLength() { return m_nTrackLength; }
...
size_t Track::getPatterns() { return m_mPatterns.size(); }

void Track::setMap(uint8_t map) { m_nMap = map; }

uint8_t Track::getMap() { return m_nMap; }

void Track::solo(bool solo) { m_bSolo = solo; }
...
void Track::setModified() { m_bChanged = true; }
...
bool Track::isEmpty() { return m_bEmpty; }
